...
```{r, eval=T}
# Clare is interested in re-ordering columns with the stepwise and lasso est first to make comparisons easier for her (ML estimates)
...
```{r, results='markup', eval=T}
# revised tables per Clare's request 5/2022
kable(test2.rev.pre,
      booktabs=T, 
